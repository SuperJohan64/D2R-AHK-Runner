...
if (Test-Path $xmlPath) {
    ...
    $sourceDirectory = Read-Host "`nEnter the source folder for your single player characters.`nLeave blank and press enter to use the default path ($defaultSourceDirectory).`n`nSource Folder Path"
