...
1. Install [AutoHotKey](https://www.autohotkey.com){:target="_blank" rel="noopener"}.
...
4. Move the [MF_run_counter.exe](https://github.com/oskros/MF_run_counter/releases){:target="_blank" rel="noopener"} to the same folder as these scripts.
